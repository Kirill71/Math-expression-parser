...
public:
	...
	inline const string& get_postfix_expression() const;  //геттер для доступа к выражению в постфиксной нотации.
private:
	void with_space(const string & exp, string & infix_expression);
